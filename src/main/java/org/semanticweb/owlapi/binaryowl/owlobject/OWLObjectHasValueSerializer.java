...
public class OWLObjectHasValueSerializer extends OWLObjectSerializer<OWLObjectHasValue> {
    ...
    @Override
    protected void writeObject(OWLObjectHasValue object, BinaryOWLOutputStream outputStream) throws IOException {
        outputStream.writeOWLObject(object.getProperty());
        outputStream.writeOWLObject(object.getValue());
    }

    @Override
    protected OWLObjectHasValue readObject(BinaryOWLInputStream inputStream) throws IOException, BinaryOWLParseException {
        OWLObjectPropertyExpression property = inputStream.readOWLObject();
        OWLIndividual value = inputStream.readOWLObject();
        return inputStream.getDataFactory().getOWLObjectHasValue(property, value);
    }
}
