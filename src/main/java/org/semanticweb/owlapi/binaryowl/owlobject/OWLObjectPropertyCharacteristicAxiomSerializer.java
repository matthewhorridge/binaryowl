...
public abstract class OWLObjectPropertyCharacteristicAxiomSerializer<A extends OWLObjectPropertyCharacteristicAxiom> extends AbstractAxiomSerializer<A> {
    ...
    @Override
    protected A readAxiom(BinaryOWLInputStream inputStream, Set<OWLAnnotation> annotations) throws IOException, BinaryOWLParseException {
        OWLObjectPropertyExpression propertyExpression = inputStream.readOWLObject();
        return createAxiom(propertyExpression, annotations, inputStream.getDataFactory());
    }
