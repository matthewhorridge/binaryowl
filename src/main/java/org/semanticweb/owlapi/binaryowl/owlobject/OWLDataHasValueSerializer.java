...
public class OWLDataHasValueSerializer extends OWLObjectSerializer<OWLDataHasValue> {
    ...
    @Override
    protected OWLDataHasValue readObject(BinaryOWLInputStream inputStream) throws IOException, BinaryOWLParseException {
        OWLDataPropertyExpression property = inputStream.readOWLObject();
        OWLLiteral value = inputStream.readOWLObject();
        return inputStream.getDataFactory().getOWLDataHasValue(property, value);
    }
}
