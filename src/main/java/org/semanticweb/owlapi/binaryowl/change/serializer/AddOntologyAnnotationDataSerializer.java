...
public class AddOntologyAnnotationDataSerializer extends OntologyChangeDataSerializer<AddOntologyAnnotationData> {
    ...
    @Override
    public void write(AddOntologyAnnotationData recordData, BinaryOWLOutputStream outputStream) throws IOException {
        OWLAnnotationSerializer serializer = new OWLAnnotationSerializer();
        serializer.write(recordData.getAnnotation(), outputStream);
    }

    @Override
    public AddOntologyAnnotationData read(BinaryOWLInputStream inputStream) throws IOException, BinaryOWLParseException {
        OWLAnnotationSerializer serializer = new OWLAnnotationSerializer();
        OWLAnnotation annotation = serializer.read(inputStream);
