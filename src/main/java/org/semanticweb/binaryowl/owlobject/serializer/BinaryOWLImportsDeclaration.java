...
public class BinaryOWLImportsDeclaration {
    ...
    public BinaryOWLImportsDeclaration(BinaryOWLInputStream inputStream) throws IOException, BinaryOWLParseException {
        IRISerializer serializer = new IRISerializer();
        IRI iri = serializer.readObject(inputStream);
        importsDeclaration = inputStream.getDataFactory().getOWLImportsDeclaration(iri);
    }
