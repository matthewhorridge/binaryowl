...
//    protected <O extends OWLObject> Set<O> readOWLObjects(LookupTable lookupTable, DataInput bos, OWLDataFactory dataFactory) throws IOException, BinaryOWLParseException {
