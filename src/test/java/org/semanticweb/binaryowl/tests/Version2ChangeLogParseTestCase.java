 ...
 * 04/06/15
 */
public class Version2ChangeLogParseTestCase {
    ...
    public void setUp() throws Exception {
        changeDataURL = Version1ChangeLogParseTestCase.class.getResource("/change-data-v2.binary");
        df = OWLManager.getOWLDataFactory();
    }

    @Test
    public void shouldParseVersion2ChangeLog() throws Exception {
        try {
